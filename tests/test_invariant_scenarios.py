...
from chatbot.context import validate_draft_against_invariants
from chatbot.storage import load_last_session, save_session
...
class TestInvariantPersistence:
    ...
    def test_invariants_survive_save_load_round_trip(self, monkeypatch, tmp_path):
        ...
        from chatbot.main import _apply_session_data, _build_session_payload
