...
from llm_agent.chatbot.models import AgentMode, SessionState
...
class TestGenerateClarificationQuestion:
    def test_returns_question_from_llm(self):
        from llm_agent.chatbot.context import generate_clarification_question
...
class TestRunPlanBuilderKeyboardInterrupt:
    def test_keyboard_interrupt_during_step_prints_message(self, capsys, monkeypatch, tmp_path):
        ...
        from llm_agent.chatbot.main import _run_plan_builder
        from llm_agent.chatbot.models import StepStatus, TaskPlan, TaskStep
        from datetime import datetime
...
class TestConfirmAndCreateTasks:
    ...
    def test_affirmative_creates_tasks(self, monkeypatch, tmp_path):
        from llm_agent.chatbot.main import _confirm_and_create_tasks
...
class TestHandlePlanAwaitingTask:
    ...
    def test_empty_input_stays_awaiting_task(self, capsys):
        from llm_agent.chatbot.main import _handle_plan_awaiting_task
...
class TestHandlePlanAwaitingInvariants:
    ...
    def test_no_transitions_to_active_and_kicks_off(self, capsys):
        from llm_agent.chatbot.main import _handle_plan_awaiting_invariants
...
class TestRunPlanBuilderResultAggregation:
    def test_aggregates_step_results_into_plan(self, capsys, monkeypatch, tmp_path):
        ...
        from llm_agent.chatbot.main import _run_plan_builder
        from llm_agent.chatbot.models import StepStatus, TaskPlan, TaskStep, TaskPhase
        from datetime import datetime
